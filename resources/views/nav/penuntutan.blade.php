...
@section('konten')
  <div class="container-pydk">
    ...
    <table table id="table-penyidikan" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
        <thead>
            <tr>
                <th>Kode</th>
                <th>Bidang</th>
    ...
    <div class="pagination">
      <div class="pagination-info mt-3">
        Showing {{ $dataArsip->firstItem() }} to {{ $dataArsip->lastItem() }} of {{ $dataArsip->total() }} results
      </div>
      {{ $dataArsip->links() }}
    </div>
  </div>
